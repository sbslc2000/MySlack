...
public class Initializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        User user = userService.createUser(id, email, nickname, profileImage);
        workspaceService.createWorkspace(user.getId(),new WorkspaceCreateRequestDto("내 슬랙 프로젝트",null,"기록"));
    }
